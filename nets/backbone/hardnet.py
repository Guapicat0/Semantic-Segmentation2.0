...
class HarDNet(nn.Module):
    def __init__(self, depth_wise = True, arch=39, pretrained=False, weight_path='',num_classes=4):
        super().__init__()
        first_ch = [32, 64]
        second_kernel = 3
        max_pool = True
...
if __name__ == "__main__":
    ...
    model = HarDNet(depth_wise = True, arch=39, pretrained=False, weight_path='',num_classes=4).train().to(device)
