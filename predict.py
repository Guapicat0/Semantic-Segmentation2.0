...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "predict_dir/predict_dir_in/"
    dir_save_path   = "predict_dir/SegNet/predict4"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                r_image = net.detect_image(image, count=count, name_classes=name_classes)
                r_image.show()
        ...
        net.convert_to_onnx(simplify, onnx_save_path)
